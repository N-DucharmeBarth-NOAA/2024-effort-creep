...
# set working directory
	...
	dir_utility = "D:/HOME/SAP/Code/Utilities/"
...
# set up effort creep vector
	# effort_creep.vec = c(0,1,3,6)
	effort_creep.vec = c(1.5,2,2.5)
...
# make plots
	...
	dir.create(dir_plot,recursive=TRUE,showWarnings=FALSE)
	source(paste0(dir_utility,"turbo.r"))
		...
		model_name = c("2019 Diagnostic","MFCL v2084 - 0%/yr","MFCL v2084 - 1%/yr","MFCL v2084 - 1.5%/yr","MFCL v2084 - 2%/yr","MFCL v2084 - 2.5%/yr","MFCL v2084 - 3%/yr","MFCL v2084 - 6%/yr")
	...
	# recruitment
		...
		p = rec_dt %>%
			...
			geom_hline(yintercept = 0) +
	  		...
	  		scale_color_manual("Manual",values = c("black",turbo_vec(7,start = 0.1, end = 0.8)))
